...
\lstinputlisting[caption={Описание \eng{RS}-защелки на языке \eng{Verilog}}, ]{./code_examples/lab_2/rs_latch.v}
...
\lstinputlisting[caption={Описание \eng{D}-триггера на языке \eng{Verilog}}, ]{./code_examples/lab_2/d_flipflop.v}
...
\lstinputlisting[caption={Описание регистра на языке \eng{Verilog}}, ]{./code_examples/lab_2/register.v}
...
\lstinputlisting[caption={Пример присвоения значения переменной в разных блоках \eng{always} на языке \eng{Verilog}}, ]{./code_examples/lab_2/error_example.v}
...
\lstinputlisting[caption={Описание восьмибитного счетчика на языке \eng{Verilog}}, ]{./code_examples/lab_2/counter.v}
...
\lstinputlisting[caption={Описание схемы синхронизации на языке \eng{Verilog}}, ]{./code_examples/lab_2/button_syncroniser.v}
